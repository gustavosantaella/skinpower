	...
	<tbody>
		<?php $__currentLoopData = $list->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr>
				...
				<td>
					<a href="<?php echo e(route('ver pedido',[Crypt::encryptString($element->idorder),Crypt::encryptString($element->id)])); ?>" class="btn btn-primary font-weight-bold">Consultar</a>
				</td>
			</tr>
...
<?php echo $__env->make('layouts.HeaderAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TheSkinPower\resources\views/Admin/orders/list.blade.php ENDPATH**/ ?>