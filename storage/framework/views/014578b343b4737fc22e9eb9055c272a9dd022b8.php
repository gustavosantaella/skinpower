...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" style="background: pink!important" id="accordionSidebar">
			...
			<!-- Sidebar - Brand -->
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('AdminHome')); ?>">
			...
			<li class="nav-item active">
				...
				<div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?php echo e(route('add product')); ?>">Agregar Productos</a>
						<a class="collapse-item" href="<?php echo e(route('listar productos')); ?>">Listar Productos</a>
...
<?php /**PATH C:\xampp\htdocs\TheSkinPower\resources\views/layouts/HeaderAdmin.blade.php ENDPATH**/ ?>