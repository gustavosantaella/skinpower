...
<div class="img-fluid">
	<a href="<?php echo e(route('HomePage')); ?>" title=""><img src="<?php echo e(asset('img/TheSkinPower1.jpg')); ?>" width="50" height="50" class=" rounded-circle" alt=""></a>
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown no-arrow mx-1">
						<a class="nav-link dropdown-toggle" href="<?php echo e(route('list orders user',[Crypt::encryptString($_SESSION['iduser'])])); ?>" id="alertsDropdown" >
					...
					<a class="dropdown-item " href="<?php echo e(url('Admin/Home')); ?>" style="cursor: pointer;">
