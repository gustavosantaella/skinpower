...
<link rel="icon"  href="<?php echo e(asset('img/TheSkinPower1.jpg')); ?>">
		...
		<div id="content">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown no-arrow mx-1">
					<a class="nav-link dropdown-toggle" href="<?php echo e(url('Page/Store')); ?>" id="alertsDropdown" >
						<i class="fas fa-store-alt"></i>

					</a>
				</li>
				<li class="nav-item dropdown no-arrow mx-1">
					<a class="nav-link dropdown-toggle" href="<?php echo e(url('Cart/Show')); ?>" id="alertsDropdown" >
				...
				<li class="nav-item dropdown no-arrow mx-1">
					<a class="nav-link dropdown-toggle" href="<?php echo e(url('/')); ?>" id="alertsDropdown" >
				...
				<?php else: ?>
				<a class="dropdown-item " href="<?php echo e(url('User/SignIn')); ?>" style="cursor: pointer;">
					<i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
					SignUp
				</a>
				<?php endif ?>
	...
	<div class=" w-100">
		<div class="footer-body shadow-lg w-100 shadow-sm ">
						...
						<div class="card-body ">
							...
							<form class="">
								...
								<fieldset class="form-group">
									...
									<button class="btn btn-primary font-weight-bold" type="submit">Send mail</button>
								</fieldset>
							</form>
						</div>
					</div>
				...
				<div class="col-md-5">
					<div class="p-xl-5">
						<div class="social text-center">
							<p class="font-weight-bold h5 mb-5">Contact us through our social networks</p>
					...
					<div class="img-fluid">
						<img src="<?php echo e(asset('img/TheSkinPower1.jpg')); ?>" alt="The skin power" width="200" height="200" class="rounded-pill offset-md-5" >
					</div>
				</div>
			...
			<div class="copyright text-center my-auto">
				<span>Copyright &copy; The Skin Power  <?php echo e(date('Y')); ?>, All rights reserved.</span>
			</div>
		</div>
...
<script src="<?php echo e(asset('js/jquery/jquery/jquery.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\TheSkinPower\resources\views/layouts/HeaderPage.blade.php ENDPATH**/ ?>