	...
	<form method="POST" action="<?php echo e(route('add product')); ?>" enctype="multipart/form-data">
		...
		<fieldset class="form-group">
			...
			<select  required=""  class="val form-control" name="status" id="exampleSelect1">
				...
				<option value=<?php echo e(FALSE); ?>>Inactivo</option>
...
<?php echo $__env->make('layouts.HeaderAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TheSkinPower\resources\views/Admin/products/add.blade.php ENDPATH**/ ?>