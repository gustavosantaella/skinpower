                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">U forgot password?</h1>
                                    </div>
                                    <?php if($errors->any()): ?>
                              ...
                              <?php endif; ?>
                              <form class="user" method="post" id="form" action="<?php echo e(url('User/ForgotPassword')); ?>">
                                <?php echo csrf_field(); ?>
                                
                                <div class="form-group">
                                    <input type="email" required="" id="mail"  name="email" value="<?php echo e(old('email')); ?>" class="form-control form-control-user val"
...
<?php /**PATH C:\xampp\htdocs\TheSkinPower\resources\views/Users/forgotPassword.blade.php ENDPATH**/ ?>