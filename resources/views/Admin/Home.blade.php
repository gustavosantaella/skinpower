				...
				<div class="row no-gutters align-items-center">
					<div class="col mr-2">
						...
						<div class="h5 mb-0 font-weight-bold text-gray-800">
							{{(DB::table('users')->where('rol','CLIENT')->count()>100)?"+100" : DB::table('users')->where('rol','CLIENT')->count()}}
						</div>
					</div>
					<div class="col-auto">
			...
			<div class="card-body">
				<div class="row no-gutters align-items-center">
					<div class="col mr-2">
						...
						<div class="h5 mb-0 font-weight-bold text-gray-800">
							{{(DB::table('users')->where('rol','ADMIN')->count()>100)?"+10" : DB::table('users')->where('rol','ADMIN')->count()}}
						</div>
					</div>
					<div class="col-auto">
			...
			<div class="card-body">
				<div class="row no-gutters align-items-center">
					<div class="col mr-2">
						...
						<div class="row no-gutters align-items-center">
							<div class="col-auto">
								<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{(DB::table('sales')->count()>100)?"+100" : DB::table('sales')->count()}}</div>
							</div>
...
{{-- 
		<div class="col col-md-5">
			<div class="card ">
				<canvas id="detalle" width="400" height="400"></canvas>
			</div>
		</div> --}}
...
<script>
	...
	var myChart = new Chart(ctx, {
		...
		data: {
			...
			@foreach ($sales as $e)
			'{{date('d-m-Y {{-- H:i:s --}}',strtotime($e->fecha))}}',
			@endforeach
