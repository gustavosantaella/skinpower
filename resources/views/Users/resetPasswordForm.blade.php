                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                              ...
                              @endif
                              <form class="user" method="post" id="form" action="{{ url('User/resetPass') }}">
                                @csrf
                                
                                <div class="form-group">
                                    <h6>Enter your new password</h6>
                                    <input type="password" required="" id="mail" minlength="6" name="pass" value="{{old('email')}}" class="form-control form-control-user val"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" required="" id="mail"  minlength="6"name="repeat" value="{{old('email')}}" class="form-control form-control-user val"
                                    id="exampleInputEmail" aria-describedby="emailHelp"
                                    placeholder="Repeat password...">

                                    <input type="hidden" name="id" value="{{ Crypt::encryptString($id) }}" placeholder="">
                                </div>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="{{ url('User/Register') }}">I dont have account</a>
                            </div>
                            <div class="text-center">
                                <a class="small" href="{{ url('User/SignIn') }}">I have a account</a>
                            </div>
